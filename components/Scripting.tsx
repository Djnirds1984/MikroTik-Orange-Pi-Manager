  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-wrap gap-2">
            {EXAMPLE_PROMPTS.map((example, index) => (
              <button
                ...
                disabled={isLoading}
                className="bg-slate-700 hover:bg-slate-600 disabled:bg-slate-800 disabled:cursor-not-allowed text-sm text-slate-300 px-3 py-1.5 rounded-md transition-colors duration-200"
              >
                {example.title}
              </button>
            ))}
      ...
      <div className="flex flex-col">
        <div className="bg-slate-800 rounded-lg p-4 flex-grow relative border border-slate-700 min-h-[300px] lg:min-h-[480px]">
          {isLoading && (
          ...
          {error && (
            <div className="text-red-400 p-4 border border-red-500 bg-red-900/20 rounded-md">
