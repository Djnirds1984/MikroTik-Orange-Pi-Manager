...
import { getInterfaces, getSslCertificates } from '../services/mikrotikService.ts';
         ...
         <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6">
                <div className="space-y-4">
                    ...
                    <button onClick={handleGenerate} disabled={isGenerating} className="w-full bg-[--color-primary-600] hover:bg-[--color-primary-500] text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center disabled:opacity-50">
                        {isGenerating ? 'Generating...' : 'Generate Setup Script'}
                    </button>
                </div>
