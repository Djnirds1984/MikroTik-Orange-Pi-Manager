...
export const VoucherHotspot: React.FC<ViewProps> = ({ selectedRouter }) => <ViewPlaceholder name="Voucher Hotspot" requiresRouter={true} selectedRouter={selectedRouter} />;

export default VoucherHotspot;
